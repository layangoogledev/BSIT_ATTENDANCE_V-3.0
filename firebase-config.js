...
// Region must match where verifyAndRecordAttendance is deployed
// (functions.https.onCall defaults to us-central1 unless region() is set
// in index.js — keep these in sync).
